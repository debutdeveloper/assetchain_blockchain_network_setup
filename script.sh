...
CORE_PEER_TLS_ROOTCERT_FILE=$PWD/crypto-config/peerOrganizations/debutinfotech.com/peers/peer0.debutinfotech.com/tls/server.crt \
CORE_PEER_MSPCONFIGPATH=$PWD/crypto-config/peerOrganizations/debutinfotech.com/users/Admin@debutinfotech.com/msp \
...
#Join Peer 1
CORE_PEER_LOCALMSPID="debutMSP" \
CORE_PEER_TLS_ROOTCERT_FILE=$PWD/crypto-config/peerOrganizations/debutinfotech.com/peers/peer1.debutinfotech.com/tls/server.crt \
CORE_PEER_MSPCONFIGPATH=$PWD/crypto-config/peerOrganizations/debutinfotech.com/users/Admin@debutinfotech.com/msp \
...
#Join Peer 2
CORE_PEER_LOCALMSPID="debutMSP" \
CORE_PEER_TLS_ROOTCERT_FILE=$PWD/crypto-config/peerOrganizations/debutinfotech.com/peers/peer2.debutinfotech.com/tls/server.crt \
CORE_PEER_MSPCONFIGPATH=$PWD/crypto-config/peerOrganizations/debutinfotech.com/users/Admin@debutinfotech.com/msp \
